...
Goal: Label data accurately and consistently
Do NOT overthink—follow guidelines


📋 Task 1: Sentiment + Topic Labeling

Label each row with:
Sentiment → Positive / Negative / Neutral
Topic → Product / Shipping / Customer Service
